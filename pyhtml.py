...
def sborka():
    name = open("name.txt", "r", encoding="utf-8").read()
    widjet = open("wiwi.txt", "r", encoding="utf-8").read()
    ...
    sit12 = (f'''
            <title>{name}</title>
            <meta name="og:title" content="{name}"><meta name="twitter:title" content="{name}"><meta name="og:site_name" content="{name}"><meta name="og:image" content="https://airsite.nyc3.cdn.digitaloceanspaces.com/brand/icon-256.png"><meta name="twitter:image" content="https://airsite.nyc3.cdn.digitaloceanspaces.com/brand/icon-256.png"><meta name="og:type" content="website"><meta name="twitter:card" content="summary">
            <link href="http://{name}top.ru/null" rel="shortcut icon">
            <link href="http://{name}top.ru/" rel="canonical"><meta name="next-head-count" content="12">''')
    sit13 = '''
