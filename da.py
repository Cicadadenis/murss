...
def sborka():
    ...
    * { box-sizing: border-box; margin: 0; padding: 0 }
    ...
    with open("3/fafafaf.html", "w", encoding="utf-8") as f:
        f.write(sait)